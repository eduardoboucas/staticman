...
class ErrorHandler {
  ...
  getErrorCode (error) {
    return ErrorHandler.ERROR_CODE_ALIASES[error] || error
  }

  getMessage (error) {
    return ErrorHandler.ERROR_MESSAGES[error]
  }
...
module.exports = (...args) => errorHandler._save(...args)
module.exports.getInstance = () => errorHandler
